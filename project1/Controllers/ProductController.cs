...
namespace Api.Controllers
{
  ...
  public class ProductController : ControllerBase
  {
    ...
    [FromQuery] int?[] styleIds) 
        ...
        [HttpPost]
        public async Task<ActionResult<DtoProduct_Id_Name_Category_Price_Desc_Image>> Post([FromQuery] DtoProduct_Name_Description_Price_Stock_CategoryId_IsActive_StyleIds productDto)
        {
